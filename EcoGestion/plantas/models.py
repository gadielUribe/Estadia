...
class plantaArbol(models.Model):
    ...
    fecha_plantacion = models.DateTimeField(verbose_name="FechaPlantación", null=False)
    imagen_url= models.CharField(verbose_name="ImagenURL", max_length=300, null=True, blank=True)
