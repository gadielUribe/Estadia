...
class SaludRegistro(models.Model):
    ...
    planta = models.ForeignKey('plantas.plantaArbol', on_delete=models.CASCADE, related_name='registros_salud', verbose_name="Planta/Árbol", db_index=True)
    fecha_actualizacion = models.DateTimeField(auto_now_add=True, verbose_name="Fecha actualización", db_index=True)
    estado_salud = models.CharField(max_length=8, choices=ESTADOS, default='verde', verbose_name="Estado de salud", db_index=True)
    usuario = models.ForeignKey('usuario.Usuario', on_delete=models.SET_NULL, null=True, blank=True, related_name='registros_salud', verbose_name="Usuario")
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=['planta', 'fecha_actualizacion']),
